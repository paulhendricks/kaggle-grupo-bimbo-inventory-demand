...
train<-h2o.uploadFile("./data/prepped/train.csv",destination_frame = "train.hex")
...
## load test file
test<-h2o.uploadFile("./data/prepped/test.csv",destination_frame = "test.hex")
...
h2o.exportFile(submissionFrame,path="./submissions/h2o_gbm.csv")  ## export submission
